...
import verifyEmailTemplate from "../utils/verifyEmailTemplate.js";
import generatedAccessToken from "../utils/generatedAccessToken.js";
import genertedRefreshToken from "../utils/generatedRefreshToken.js"; // keep original name if this is your util filename
import uploadImageClodinary from "../utils/uploadImageClodinary.js";
import generatedOtp from "../utils/generatedOtp.js";
import forgotPasswordTemplate from "../utils/forgotPasswordTemplate.js";
import jwt from "jsonwebtoken";

// PRODUCTION SAFE COOKIE OPTIONS (works with Vercel + cross-site)
const cookieOptions = {
...
export async function loginController(req, res) {
  try {
    ...
    // Return access token in response body (frontend uses this for immediate authorization)
    return res.json({
      message: "Login successfully",
      error: false,
      success: true,
...
export async function logoutController(req, res) {
  try {
    ...
    // Clear cookies using same cookie options (path matters)
